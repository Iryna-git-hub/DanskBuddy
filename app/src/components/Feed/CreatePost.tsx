    ...
    <div className="bg-white rounded-2xl shadow-card p-4 lg:p-6">
      <div className="flex items-center gap-3">
        ...
        <input
          ...
          className="flex-1 h-[44px] lg:h-[52px] rounded-full bg-background border-none outline-none px-4 lg:px-5 text-sm lg:text-[0.95rem] text-foreground placeholder:text-neutral-light"
        />
        <button
          onClick={submit}
