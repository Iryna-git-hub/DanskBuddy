...
export default function TopBar({ onSearch }: Props) {
  ...
  return (
    <header className="fixed top-[64px] left-0 lg:left-[300px] right-0 h-[72px] lg:h-[90px] flex items-center justify-between px-4 lg:px-10 bg-white border-b border-[#ebe5dd] z-50">
      ...
      <div className="flex items-center gap-3">
        {/* Search — desktop only */}
        <div className="hidden lg:flex items-center gap-2 w-[280px] h-12 bg-white border border-[#ece6dd] rounded-full px-5">
        ...
        <div className="relative" ref={ref}>
          <button
            onClick={toggleOpen}
            className="relative w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-white border border-[#ece6dd] flex items-center justify-center cursor-pointer hover:bg-background transition-colors"
          >
