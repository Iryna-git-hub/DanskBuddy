  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-6 py-3">
        ...
        {/* Translate */}
        <button className="flex items-center gap-1.5 bg-transparent border-none cursor-pointer text-[0.85rem] text-neutral p-0">
          🌐 Oversæt
        </button>
      </div>
        ...
        <div className="border-t border-surface pt-4 mt-1">
          ...
          <div className="flex gap-2.5 mb-4">
            <input
              ...
              className="flex-1 h-[46px] rounded-full bg-background border-none outline-none px-4 text-[0.9rem] text-foreground placeholder:text-neutral-light"
            />
            <button
